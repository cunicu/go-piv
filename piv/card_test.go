...
func runContextTest(t *testing.T, f func(t *testing.T, c Context)) {
...
func TestContextClose(t *testing.T) {
	runContextTest(t, func(t *testing.T, c Context) {})
}
...
func testContextListReaders(t *testing.T, c Context) {
	if _, err := c.ListReaders(); err != nil {
		t.Errorf("listing readers: %v", err)
	}
}

func runHandleTest(t *testing.T, f func(t *testing.T, h Card)) {
	runContextTest(t, func(t *testing.T, c Context) {
...
func TestHandle(t *testing.T) {
	runHandleTest(t, func(t *testing.T, h Card) {})
}
